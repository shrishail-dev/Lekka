...
@Composable
fun AddLentScreen(onDone: () -> Unit, editingLentId: Long? = null) {
    val context = LocalContext.current
    val app = context.applicationContext as ExpenseTrackerApp
    val viewModel: AddLentViewModel = viewModel(
        factory = viewModelFactory {
            initializer { AddLentViewModel(app.lentRepository, editingLentId) }
        }
    )
            ...
            TopAppBar(
                title = {
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Text(
                            if (viewModel.isEditing) "Edit Lent" else "Add Lent",
        ...
        Column(
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    label = { Text("Lent to (optional)", style = MaterialTheme.typography.bodySmall) },
                    textStyle = MaterialTheme.typography.bodyMedium,
                    singleLine = true,
                    modifier = Modifier.fillMaxWidth()
                )
            ...
            Button(
                ...
                Text(
                    if (viewModel.isEditing) "Update Lent" else "Save Lent",
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
private fun LentDatePickerDialog(
